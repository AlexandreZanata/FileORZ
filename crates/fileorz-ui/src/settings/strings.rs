...
pub struct SettingsStrings {
    ...
    pub card_lang_title: String,
    pub card_lang_body: String,
...
impl SettingsStrings {
    ...
    pub fn from_localization(loc: &Localization) -> Self {
        ...
        Self {
            ...
            card_lang_title: loc.message("settings-card-language-title"),
            card_lang_body: loc.message("settings-card-language-body"),
